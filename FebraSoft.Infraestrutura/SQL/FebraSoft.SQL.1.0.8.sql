...
ALTER TABLE [dbo].[tbNFesRecebidasItens]  WITH CHECK ADD  CONSTRAINT [FK_tbNFesRecebidasItens_tbNfesRecebidas] FOREIGN KEY([numeroNfeRecebida])
REFERENCES [dbo].[tbNfesRecebidas] ([numeroNfeRecebida])
GO

ALTER TABLE [dbo].[tbNFesRecebidasItens] CHECK CONSTRAINT [FK_tbNFesRecebidasItens_tbNfesRecebidas]
GO
